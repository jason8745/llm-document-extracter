...
class TestChineseSummarizer:
    ...
    def sample_document(self):
        ...
        sections = [
            ...
            DocumentSection(
                title="Method", content="We propose a new neural network architecture."
            ),
            DocumentSection(
                title="Results",
            ...
            DocumentSection(
                title="Conclusion", content="This work opens new research directions."
            ),
        ]
        return ExtractedDocument(
            title="Novel ML Approach", sections=sections, source_file="paper.pdf"
        )
    ...
    def test_summarize_section_with_specific_prompt(self, summarizer, mock_llm):
        ...
        result = summarizer.summarize_section(
            "Abstract", "This is an abstract about AI research.", "Test Paper"
        )
    ...
    def test_summarize_section_with_generic_prompt(self, summarizer, mock_llm):
        ...
        result = summarizer.summarize_section(
            "Unknown Section", "This is unknown content.", "Test Paper"
        )
    ...
    def test_generate_summary(self, summarizer, mock_llm, sample_document):
        ...
        mock_llm.invoke.side_effect = [
            AIMessage(content=resp) for resp in mock_responses
        ]
    ...
    def test_llm_error_handling(self, mock_llm):
        ...
        with patch(
            "docxtract.summarizer.AzureChatOpenAI",
