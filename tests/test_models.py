...
class TestSummaryRequest:
    ...
    def test_summary_request_minimal(self):
        ...
        request = SummaryRequest(
            document_content="Sample content for testing."
        )
...
class TestModelIntegration:
    ...
    @pytest.mark.parametrize("section_name,expected_found", [
        ("Abstract", True),
        ("Introduction", True),
        ("Method", True),
        ("Results", True),
    ...
    def test_section_existence_parameterized(self, sample_extracted_document, section_name, expected_found):
